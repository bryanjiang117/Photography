...
export default function CanadaGallery() {
  ...
  return (
    <motion.div
      ...
      className="fixed inset-0 z-50 flex overflow-hidden bg-canada-primary"
    >
      ...
      <motion.div
        ...
        className="pointer-events-none absolute left-8 top-6 z-20 flex flex-col items-start"
      >
        <div
      ...
      <motion.button
        ...
        className="absolute bottom-6 left-8 z-20 flex items-center gap-2 cursor-pointer transition-colors duration-200 p-3 -m-3"
      >
      ...
      <motion.div
        ...
        animate={{ opacity: 1 }}
        transition={{ delay: 0.42, duration: 0.55, ease: "easeOut" }}
        className="pointer-events-none absolute bottom-6 right-10 z-20 flex flex-col items-end gap-3"
      >
        <div
